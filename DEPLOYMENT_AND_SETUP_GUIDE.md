...
**A. Akun Pusat (Tanpa Lokasi Spesifik):**
...
| **Dinas PEMDA DKI** | `pemda.dki@smarthub.go.id` | `password123` | Monitoring Wilayah DKI Jakarta, Input Operasional |
| **Dinas PEMDA Sumut** | `pemda.sumut@smarthub.go.id` | `password123` | Monitoring Wilayah Sumatera Utara, Input Operasional |
| **Dinas PEMDA Jatim** | `pemda.jatim@smarthub.go.id` | `password123` | Monitoring Wilayah Jawa Timur, Input Operasional |

**B. Akun Lapangan (Terkunci pada Lokasi)**
Gunakan pola email ini: `[role].[namalokasi]@smarthub.go.id` (Password semua akun: `password123`).

**Lokasi yang tersedia:**
1. `muarabaru` (KNMP Muara Baru)
2. `cilacap` (KNMP Cilacap)
3. `brondong` (KNMP Brondong)
4. `bitung` (KNMP Bitung)
5. `palabuhanratu` (KNMP Palabuhanratu)
6. `ternate` (KNMP Ternate)

| Role Lapangan | Format Email | Contoh (Untuk Muara Baru) |
| :--- | :--- | :--- |
| **Petugas TPI** | `tpi.[lokasi]@smarthub.go.id` | `tpi.muarabaru@smarthub.go.id` |
| **Koperasi Nelayan** | `kop.[lokasi]@smarthub.go.id` | `kop.muarabaru@smarthub.go.id` |
| **Penyuluh Lapangan** | `pen.[lokasi]@smarthub.go.id` | `pen.muarabaru@smarthub.go.id` |
