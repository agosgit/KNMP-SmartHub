...
const DEMO_ACCOUNTS = [
  {
    ...
    badge: 'TINGKAT 1: KKP PUSAT',
    email: 'kkp@smarthub.go.id',
    desc: 'Monitoring Nasional, Rekalkulasi TOPSIS & Ekspor Laporan PDF',
    accent: '#00F2FE',
  ...
  {
    role: 'PEMDA',
    title: 'Dinas Kelautan & Perikanan',
    subtitle: 'Ratna Dewi (DKP DKI)',
    badge: 'TINGKAT 2: DINAS DAERAH',
    email: 'pemda.dki@smarthub.go.id',
    desc: 'Dashboard Wilayah Provinsi & Pengawasan Teritorial',
    accent: '#38BDF8',
  ...
  {
    role: 'TPI',
    title: 'Petugas TPI (Pelelangan)',
    subtitle: 'Petugas Muara Baru',
    badge: 'TINGKAT 3: LAPANGAN (TPI)',
    email: 'tpi.muarabaru@smarthub.go.id',
    desc: 'Pencatatan Hasil Tangkapan Harian & Kelaikan Cold Storage',
    accent: '#10B981',
  ...
  },
  {
    ...
    badge: 'TINGKAT 3: LAPANGAN (KOPERASI)',
    email: 'kop.muarabaru@smarthub.go.id',
    desc: 'Pencatatan Distribusi Hasil Laut & Transaksi Anggota',
    accent: '#F5AF19',
  ...
  },
  {
    ...
    badge: 'TINGKAT 3: LAPANGAN (PENYULUH)',
    email: 'pen.muarabaru@smarthub.go.id',
    desc: 'Monitoring Kondisi Fisik Fasilitas & Pelaporan Anomali EWS',
    accent: '#A855F7',
