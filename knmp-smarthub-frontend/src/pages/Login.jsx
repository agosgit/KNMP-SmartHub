...
const DEMO_ACCOUNTS = [
  ...
  {
    role: 'PENGELOLA',
    title: 'Pengelola Kawasan KNMP',
    subtitle: 'Pengelola Muara Baru',
    badge: 'MANAJERIAL KAWASAN',
    email: 'pengelola.muarabaru@smarthub.go.id',
    desc: 'Supervisi Operasional Kawasan & Akses Input Seluruh Modul Pelabuhan',
    accent: '#06B6D4',
    borderCol: 'rgba(6, 182, 212, 0.3)',
    bgCol: 'rgba(6, 182, 212, 0.06)',
    icon: Anchor,
  },
];
